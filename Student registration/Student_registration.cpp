...
bool register_student(struct student *stud,struct list *ls)
{
    ...
    cout<<"Aggregate percentage is "<< aggregiate<<"\n";
    if (aggregiate >= 70)
    {
        cout<<"Student registered in Computer Science\n";
        addToList(s,ls);
        return true;
    }
    else if (aggregiate >= 60)
    {
        cout<<"Student registered in Information Technology\n";
        addToList(s,ls);
        return true;
    }
    else if (aggregiate >=50)
    {
        cout<<"Student registered in Electronics\n";
        addToList(s,ls);
        return true;
    }
    else
